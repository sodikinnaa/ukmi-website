        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-actions">
                    <a href="{{ route('kabid.program-kerja.index') }}" class="btn btn-secondary">Kembali</a>
                    <a href="{{ route('kabid.program-kerja.edit', $programKerja) }}" class="btn btn-primary">
                    ...
                    @if($bisaTambahPertemuan)
                        <a href="{{ route('kabid.program-kerja.pertemuan.create', $programKerja) }}" class="btn btn-success">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Peserta Program Kerja</h3>
                                <div class="card-actions">
                            ...
                            <div class="card-body">
                                        ...
                                        <table class="table table-vcenter card-table">
                                            ...
                                            <tbody>
                                                @foreach($programKerja->kader as $kader)
                                                    @php
                                                        $roleName = $kader->roleModel->name ?? 'unknown';
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $kader->email }}</td>
                                                        <td>
                                                            <form action="{{ route('kabid.program-kerja.kader.detach', [$programKerja, $kader]) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini?');">
                                                                @csrf
                                                                @method('DELETE')
                                ...
                                @else
                                    <div class="alert alert-info mb-0">
                                        <p class="mb-0">Belum ada peserta yang ditambahkan.</p>
                                    </div>
                                @endif
                            </div>
                        </div>
                ...
                <div class="modal fade" id="modalAddKader" tabindex="-1" role="dialog" aria-labelledby="modalAddKaderLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            <form action="{{ route('kabid.program-kerja.kader.attach', $programKerja) }}" method="POST" id="formAddKader">
                                @csrf
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex gap-2">
                                                <a href="{{ route('kabid.program-kerja.pertemuan.show', [$programKerja, $pertemuan]) }}" class="btn btn-sm btn-primary">
                                                ...
                                                <a href="{{ route('kabid.program-kerja.pertemuan.edit', [$programKerja, $pertemuan]) }}" class="btn btn-sm btn-outline-primary">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
