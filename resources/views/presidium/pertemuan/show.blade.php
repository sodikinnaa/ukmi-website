        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-actions">
                    <a href="{{ route('presidium.program-kerja.show', $programKerja) }}" class="btn btn-secondary">Kembali</a>
                    <a href="{{ route('presidium.program-kerja.pertemuan.edit', [$programKerja, $pertemuan]) }}" class="btn btn-primary">Edit</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row mb-4">
